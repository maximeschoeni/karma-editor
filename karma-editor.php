...
define('KARMA_FIELDS_URL', WP_PLUGIN_URL . '/' . basename(dirname(__FILE__)).'/plugins/karma-fields-v9');
define('KARMA_FIELDS_PATH', dirname(__FILE__).'/plugins/karma-fields-v9');
