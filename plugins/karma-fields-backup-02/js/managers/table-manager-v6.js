    ...
    ppp: resource.ppp || 10,
        ...
        return fetch(file, {
          ...
          return results;
				...
				return Promise.reject(new Error("Table Manager cannot request uri ("+uri+"): no resource driver or middleware"));
			}
		},
		...
		addItem: function() {
			...
			// resource.children.forEach(function(column) {
